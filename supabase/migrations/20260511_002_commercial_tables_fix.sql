-- =============================================================
-- MIGRATION: Commercial Module Tables — FIX RLS (Retry 2)
-- File: 20260511_002_commercial_tables_fix.sql
-- Description: Drop partial tables, recreate all 3 tables + view + RLS with correct auth.uid() = user_profiles.id
-- =============================================================

-- First, clean up any partial objects from failed first attempt
DROP TABLE IF EXISTS public.commercial_rate_cards CASCADE;
DROP TABLE IF EXISTS public.commercial_projects CASCADE;
DROP TABLE IF EXISTS public.commercial_project_manpower CASCADE;
...
-- Partial unique index: only 1 active per combination per tenant
...
CREATE TABLE IF NOT EXISTS public.commercial_project_manpower (
  ...
  -- SNAPSHOT rates (isolated from master changes)
...
-- Calculated on-the-fly (Option B)
-- =============================================================
...
-- =============================================================
-- RLS POLICIES (FIXED: auth.uid() = user_profiles.id)
-- =============================================================
...
-- Helper: drop any existing policies
